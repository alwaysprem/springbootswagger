...
import com.prem.demo.service.EmployeeService;
...
public class EmployeeController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Prem message 200"),
			@ApiResponse(code = 101, message = "Prem message 101") })
	@GetMapping("/get2")
